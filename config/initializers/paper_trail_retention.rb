# =========================================================
# File: config/initializers/paper_trail_retention.rb
# ---------------------------------------------------------
# 目的:
#   PaperTrail のバージョン保持ポリシーをアプリ設定に集約。
#   （実際の削除/クリーンアップ処理はタスクやジョブ側でこの値を参照）
#
# 運用:
#   - 環境変数で保持件数・保持日数・バッチサイズを制御できる。
#   - ここでは「基準値」を配置するのみで、ロジックは変更しない。
# =========================================================
